...
____________________________________________Thursday_2__________________________________________________________________
import React from 'react'
import ReactDOM from 'react-dom/client';
...
// 🖥 Пример ответа: unknown status isDone void
                                                        ...
                                                        CommentType[] RootState unknown ActionsType
...
__________________________________________Thursday_3____________________________________________________________________
import React from 'react'
import ReactDOM from 'react-dom/client';
import { applyMiddleware, combineReducers, legacy_createStore as createStore } from 'redux'
import { Provider, TypedUseSelectorHook, useDispatch, useSelector } from 'react-redux'
